...
QPointer<RetType> FString::accept(Visitor *v)
{
  return v->visitFString(this);
}
...
QPointer<RetType> ListFilter::accept(Visitor *v)
{
  return v->visitListFilter(this);
}


ListFilter *ListFilter::clone() const
{
